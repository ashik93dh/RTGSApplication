...
if __name__ == "__main__":
    ...
    trans_id=sys.argv[1]
    #trans_id='5042205163000004'
    query="""select * from call_loan.rtgs_trans where status ='I' and trans_typ='PAY' and instr_id = :trans_id"""
    ...
    for r in row:
        ...
        tr.transaction_reason=r[9].strip()
        #tr.file_location="D://STP Adapter/STPAdapterPG_v23_43_CSO/input/"+tr.business_msg_id+".xml"
        tr.file_location="D://STP Adapter/clientFiles/input/"+tr.business_msg_id+".xml"
        #print(tr.debitor_second)
        result=tr.gen_PACS009()
        if result==1 :
